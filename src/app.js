(function(angular) {
  ...
  angular.module('app', ['ngRoute'])
    ...
    .controller('SetupController', ['$scope', '$http', '$sce', function($scope, $http, $sce) {
      $http.get('http://angular-1-gulp-babel.airshipcms.io/api/pages/__root__')
        .then(function(res) {
    ...
    .controller('ElementsController', ['$scope', '$http', function($scope, $http) {
      $http.get('http://angular-1-gulp-babel.airshipcms.io/api/aerostat_collection/elements?limit=20&sort=sorting_position')
        .then(function(res) {
    ...
    .controller('ElementController', ['$scope', '$http', '$route', function($scope, $http, $route) {
      $http.get('http://angular-1-gulp-babel.airshipcms.io/api/aerostats/' + $route.current.params.id)
        .then(function(res) {
    ...
    .controller('StylingController', ['$scope', '$http', '$sce', function($scope, $http, $sce) {
      $http.get('http://angular-1-gulp-babel.airshipcms.io/api/pages/styling')
        .then(function(res) {
          res.data.fields.forEach(function(field) {
            switch(field.variable_name) {
              case 'body':
    ...
    .controller('AirshipSchemaController', ['$scope', '$http', '$sce', function($scope, $http, $sce) {
      $http.get('http://angular-1-gulp-babel.airshipcms.io/api/pages/airship-schema')
        .then(function(res) {
          res.data.fields.forEach(function(field) {
            switch(field.variable_name) {
              case 'body':
    ...
    .controller('TutorialController', ['$scope', '$http', '$sce', function($scope, $http, $sce) {
      $http.get('http://angular-1-gulp-babel.airshipcms.io/api/pages/angular-tutorial')
        .then(function(res) {
          res.data.fields.forEach(function(field) {
            switch(field.variable_name) {
              case 'body':
